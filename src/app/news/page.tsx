    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">SmartOPD Updates</h1>
          <p className="text-xl text-gray-600">
            Latest announcements and feature releases - Balanced speed and freshness
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8 border border-purple-200 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            This page demonstrates the solution to the "outdated vs slow" problem:
          </p>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg p-4">
              <div className="text-2xl mb-2">⚡</div>
              <h3 className="font-semibold text-gray-900 mb-1">Fast Like SSG</h3>
              <p className="text-sm text-gray-600">Served from cache instantly</p>
            </div>
            <div className="bg-white rounded-lg p-4">
              <div className="text-2xl mb-2">🔄</div>
              <h3 className="font-semibold text-gray-900 mb-1">Fresh Like SSR</h3>
              <p className="text-sm text-gray-600">Auto-updates every 60 seconds</p>
            </div>
            <div className="bg-white rounded-lg p-4">
              <div className="text-2xl mb-2">📈</div>
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {data.posts.slice(0, 6).map((post: any, index: number) => (
              <div
                key={post.id}
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Showing {data.posts.length} total updates • Fetched posts: <strong>{data.posts.length}</strong>
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-md border border-gray-100 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Initial Build</h3>
                <p className="text-sm text-gray-600">Page is pre-rendered at build time (like SSG)</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Serve Cached</h3>
                <p className="text-sm text-gray-600">Users get instant response from cache</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">After 60 seconds, next request triggers regeneration</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Update Cache</h3>
                <p className="text-sm text-gray-600">New version replaces old cache for subsequent users</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-green-50 rounded-2xl p-8 border border-green-200 mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-6">📊 Rendering Strategy Comparison</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-green-300">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-900 bg-green-100">ISR ✓</th>
                </tr>
              </thead>
        ...
        <div className="bg-purple-50 rounded-2xl p-8 border border-purple-200 mb-8">
          ...
          <div className="bg-white rounded-lg p-4 space-y-3">
            <div>
              <p className="text-xs text-gray-500 mb-1">Page last regenerated at:</p>
              <code className="text-sm font-mono text-gray-700">{lastUpdated.toISOString()}</code>
            </div>
            <div>
              <p className="text-xs text-gray-500 mb-1">Revalidation interval:</p>
              <code className="text-sm font-mono text-gray-700">60 seconds</code>
            </div>
            <div>
              <p className="text-xs text-gray-500 mb-1">Strategy:</p>
              <code className="text-sm font-mono text-gray-700">Stale-While-Revalidate</code>
            </div>
          </div>
          <p className="text-xs text-gray-500 mt-4">
            💡 Refresh immediately - same timestamp (cached). Wait 60 seconds and refresh - new timestamp!
          </p>
        </div>
